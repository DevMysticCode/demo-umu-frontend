  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        '22-emphasized': ['22px', { lineHeight: '28px', fontWeight: '700', letterSpacing: '-0.26px' }],
        '28-emphasized': ['28px', { lineHeight: '34px', fontWeight: '700', letterSpacing: '0.38px' }],
      }
    },
  },
  plugins: [],

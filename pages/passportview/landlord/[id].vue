      ...
      <div v-if="tnOpen" class="lp-assess">
        ...
        <div v-if="tnScreen === 'intro'" class="lp-assess-screen">
          ...
          <div class="lp-assess-scroll">
            ...
            <div class="lp-tn-verbadge"><img src="/op-icons/onboarding/trustShield.png" alt="" class="lp-tn-verbadge-ic" loading="lazy" /> <b>Template {{ TN_TEMPLATE_VERSION }}</b> - built for the Renters' Rights Act. <span class="lp-tn-pending">Final legal review pending.</span></div>
        ...
        <div v-else-if="tnScreen === 'preview'" class="lp-assess-screen">
          ...
          <div class="lp-assess-scroll">
            <div class="lp-tn-doc">
              ...
              <div class="lp-tn-docver">Generated by umovingu · Template {{ TN_TEMPLATE_VERSION }} · final legal review pending<br />Based on a template. Not legal advice.</div>
            </div>

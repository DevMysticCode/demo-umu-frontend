<template>
  <div class="mp-page">
    ...
    <div class="mp-hero-head">
      ...
      <p class="mp-hero-sub">
        Verified buyers get 3× more offers accepted. Build your profile in about
        5 minutes.
      </p>
    </div>
    ...
    <div v-if="activityStats.publishedLast7d > 0" class="live-bar">
      <img
        src="/op-icons/buyer-profile-build/buyers.png"
        alt=""
        class="live-bar-ic"
        loading="lazy"
      />
    ...
    <div class="section-header section-header--illus">
      <img
        src="/op-icons/buyer-profile-build/calendar.png"
        alt=""
        class="sec-illus"
        loading="lazy"
      />
    ...
    <div class="options-block">
      <div
        v-for="s in sections"
        :key="s.title"
        class="opt-card opt-card--compact"
      >
    ...
    <div class="mp-cta-wrap">
      <button class="cta-btn" @click="goToBuild">
        <span class="cta-btn-inner">
          <img
            src="/op-icons/buyer-profile-build/clipboard.png"
            alt=""
            class="cta-btn-ic"
            loading="lazy"
          />
...
const benefits = [
  {
    title: 'Sellers take your offer seriously',
    icon: '/op-icons/buyer-profile-build/house.png',
  },
  {
    title: 'Agents prioritise your viewings',
    icon: '/op-icons/buyer-profile-build/agent.png',
  },
  {
    title: 'Solicitors can start faster',
    icon: '/op-icons/buyer-profile-build/stopwatch.png',
  },
  {
    title: 'Verified credentials replace endless paperwork',
    icon: '/op-icons/buyer-profile-build/verifiedDoc.png',
  },
]
...
const sections = [
  {
    ...
    sub: 'Onfido KYC + DVS-certified',
    required: true,
  },
  {
    icon: '/op-icons/buyer-profile-build/bank.png',
    title: 'Proof of funds',
    sub: 'Mortgage AIP or bank statement',
    required: true,
  },
  {
    icon: '/op-icons/buyer-profile-build/chain.png',
    title: 'Chain position',
    sub: 'First-time, chain-free, or selling',
    required: true,
  },
  {
    icon: '/op-icons/buyer-profile-build/scales.png',
    title: 'Solicitor & timeline',
    sub: 'Move-readiness signals',
    required: false,
  },
  {
    icon: '/op-icons/buyer-profile-build/notepad.png',
    title: 'Your story',
    sub: 'Optional short intro to sellers',
    required: false,
  },
]

// If the previous SPA entry is another /buyer-profile/* route (e.g. the
// build wizard that pushed here on completion), stepping back would just
// bounce the user between buyer-profile pages. Break the loop by going
// straight to /profile — the natural parent of this section.
function goBack() {
  const prev = (router.options.history as any)?.state?.back
  if (typeof prev === 'string' && !prev.startsWith('/buyer-profile')) {
    router.back()
  } else {

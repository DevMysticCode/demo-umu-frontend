<template>
  <div class="bp-page">
    ...
    <div v-else-if="!passport" class="bp-empty">
      <div class="bp-empty-ic">
        <img src="/op-icons/misc/book.png" alt="" loading="lazy" />
      </div>
    ...
    <template v-else>
      ...
      >
        ...
        <div class="bp-access-banner-text">
          ...
          <div class="bp-access-banner-sub">
            {{ r.requestedScopes.length }} scope{{
              r.requestedScopes.length === 1 ? '' : 's'
            }}
      ...
      <div class="bp-hero-wrap">
        <div class="hero-card">
          <div class="bp-hero-top">
            ...
            <span class="bp-hero-strength"
              >{{ Math.round(animatedStrength) }}% STRENGTH</span
            >
          </div>
          <div class="bp-hero-body">
            ...
            <div class="bp-hero-info">
              ...
              <div class="bp-hero-pills">
                ...
                <span v-if="fundsLabelShort" class="hero-pill">{{
                  fundsLabelShort
                }}</span>
      ...
      <div class="bp-pb-wrap">
        ...
        <div class="pb-track">
          <div
            class="pb-fill"
            :style="{ width: Math.round(animatedStrength) + '%' }"
          />
        </div>
      ...
      <div class="tile-grid">
        <div class="tile">
          <div class="tile-icon">
            <img
              src="/op-icons/buyer-profile/idCard.png"
              alt=""
              loading="lazy"
            />
          </div>
        ...
        <div class="tile">
          <div class="tile-icon">
            <img
              src="/op-icons/buyer-profile/chainLink.png"
              alt=""
              loading="lazy"
            />
          </div>
      ...
      <div class="teal-card bp-docs-card">
        <div class="doc-row">
          ...
          <div class="doc-body">
            ...
            <div class="doc-meta">
              {{ idTypeLabel }} · verified by Onfido (DVS)
            </div>
          </div>
          <div class="doc-right">
        ...
        <div class="doc-row" @click="triggerUpload('funds')">
          ...
          <div class="doc-right doc-right--col">
            <span v-if="uploading === 'funds'" class="risk-pill add"
              >Uploading…</span
            >
            <span v-else-if="passport.fundsVerified" class="risk-pill clear"
              >✓ VERIFIED</span
            >
            <span
              v-else-if="passport.fundsReviewStatus === 'pending'"
              class="risk-pill add"
              >⏳ IN REVIEW</span
            >
            <span
              v-else-if="passport.fundsReviewStatus === 'rejected'"
              class="risk-pill reject"
              >✕ RESUBMIT</span
            >
        ...
        <div class="doc-row" @click="triggerUpload('mortgage')">
          ...
          <div class="doc-right">
            ...
            >
            <span
              v-else-if="passport.mortgageAipVerified"
              class="risk-pill clear"
              >✓ VERIFIED</span
            >
            <span
              v-else-if="passport.mortgageAipReviewStatus === 'pending'"
              class="risk-pill add"
              >⏳ IN REVIEW</span
            >
            <span
              v-else-if="passport.mortgageAipReviewStatus === 'rejected'"
              class="risk-pill reject"
              >✕ RESUBMIT</span
            >
            <span v-else class="risk-pill add">+ ADD DOC</span>
        ...
        <div class="doc-row">
          <div class="doc-icon">
            <img
              src="/op-icons/buyer-profile/clipboardLink.png"
              alt=""
              loading="lazy"
            />
          </div>
      ...
      <div class="bp-share-card">
        <button class="action-row" @click="goShare">
          <div class="action-icon">
            <img
              src="/op-icons/buyer-profile/upload.png"
              alt=""
              loading="lazy"
            />
          </div>
        ...
        <button class="action-row action-row--bordered" @click="goSign">
          <div class="action-icon">
            <img
              src="/op-icons/buyer-profile/signature.png"
              alt=""
              loading="lazy"
            />
          </div>
        ...
        <button class="action-row action-row--bordered" @click="goEdit">
          <div class="action-icon">
            <img
              src="/op-icons/buyer-profile/editBox.png"
              alt=""
              loading="lazy"
            />
          </div>
...
const mortgageMetaText = computed(() => {
  if (passport.value?.mortgageAipVerified)
    return 'AIP on file · lender verified'
...
// ── Navigation ───────────────────────────────────────────────
function goShare() {
  router.push('/buyer-profile/share')
}
function goPdf() {
  router.push('/buyer-profile/pdf')
}
function goSign() {
  router.push('/buyer-profile/sign')
}
function goEdit() {
...
@keyframes bp-pulse-glow {
  0%,
  100% {
    box-shadow: 0 0 0 0 rgba(240, 180, 96, 0.4);
  }
  50% {
    box-shadow: 0 0 0 6px rgba(240, 180, 96, 0);
  }
}

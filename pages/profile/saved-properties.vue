      ...
      <div v-else class="sp-grid">
        ...
        >
          <div class="sp-photo">
            ...
            <div class="sp-heart" @click.stop="onUnsave(item)" role="button" tabindex="0" @keydown.enter="onUnsave(item)" @keydown.space.prevent="onUnsave(item)">
